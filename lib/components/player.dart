...
class Player extends SpriteAnimationGroupComponent
  ...
  final double stepTime = 0.05; // 20fps
  late final SpriteAnimation idleAnimation;
  late final SpriteAnimation runningAnimation;
  late final SpriteAnimation jumpingAnimation;
  late final SpriteAnimation faillingAnimation;
  ...
  void _loadAllAnimations() {
    ...
    faillingAnimation = _spriteAnimation('Fall', 1);
    ...
    animations = {
      ...
      PlayerState.falling: faillingAnimation,
  ...
  void _respawn() async {
    playSound("hit");
    const hitDuration =
        Duration(milliseconds: 50 * 7); // 50ms per frame * 7 frames
